...
//Memory parameters
#define MEM_CHUNK_MAXSECTORS           0xFFFE
#define MEM_CHUNK_MINSECTORS           0
...
*/
static const uint16_t MEM_CHUNK_EMPTY = 0xFFFF;

/*!\var uint8_t MEM_CHUNKBLK_SIZE
	Size of MemChunk header in bytes
*/
static const uint8_t MEM_CHUNKBLK_SIZE = 2;
...
typedef struct
{
    uint16_t num_sectors;         //Size of chunk in sectors
